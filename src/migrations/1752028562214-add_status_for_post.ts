...
export class AddStatusForPost1752028562214 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."post_status_enum" AS ENUM('publish', 'pending', 'rejected')`);
        await queryRunner.query(`ALTER TABLE "post" ADD "status" "public"."post_status_enum" NOT NULL DEFAULT 'publish'`);
    }
