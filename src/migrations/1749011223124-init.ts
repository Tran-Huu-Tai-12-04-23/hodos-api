...
export class Init1749011223124 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "scheduled_notifications" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "createdBy" character varying, "createdByName" character varying(50), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedBy" character varying, "deleteBy" character varying, "isDeleted" boolean NOT NULL DEFAULT false, "userId" uuid, "title" character varying(255) NOT NULL, "message" text NOT NULL, "notificationType" "public"."scheduled_notifications_notificationtype_enum" NOT NULL, "channels" "public"."scheduled_notifications_channels_enum" array NOT NULL, "scheduledTime" TIMESTAMP WITH TIME ZONE NOT NULL, "status" "public"."scheduled_notifications_status_enum" NOT NULL DEFAULT 'pending', "payload" jsonb, "processedAt" TIMESTAMP WITH TIME ZONE, "errorMessage" text, "retryAttempts" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_9eb8b287229934bbd076a5d64f7" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP TYPE "public"."scheduled_notifications_channels_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."scheduled_notifications_notificationtype_enum"`,
    );
